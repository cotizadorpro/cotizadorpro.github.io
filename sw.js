...
const CACHE_NAME = 'cotizadorpro-v72-characteristics-mobile-gap-summary';
...
const BUILD_ID = '20260924-v72-characteristics-mobile-gap-summary';
...
self.addEventListener('fetch', function(event){
  ...
  if(u.origin===self.location.origin &&
     (u.pathname==='/' || u.pathname.endsWith('/index.html') || u.pathname.endsWith('/app.js'))){
    event.respondWith(
