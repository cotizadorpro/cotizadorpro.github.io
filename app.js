...
function buildFlyerTwoDevicesHTML(a,b){
  ...
  _cmpFooter=_cmpFooter.replace(
    ...
    '* Pago inicial sujeto a aprobación · Consulta términos y condiciones · Precios sujetos a cambio.'
  );
  h+=_cmpFooter;
  h+='</div>';
  return h;
