...
async function compararEquipoActual(){
  ...
  if(!cotEquipoComparar || !cotEquipoComparar.device){
    ...
    alert('Opción 1 guardada: '+actual.device.name+'. Ahora selecciona y configura el segundo equipo.');
    return;
  }
  ...
  if(cotEquipoComparar.device.id===actual.device.id &&
    ...
    alert('La Opción 2 debe ser otro equipo o una configuración diferente.');
    return;
  }
...
window.captureQuoteState=function(deviceId,plan,plazo,engPct){
