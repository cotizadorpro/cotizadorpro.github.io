...
let _variants=(window.STORAGE_VARIANTS || {})[id] || null;
  ...
  h+='<button onclick="enviarCotizacion()" class="wa-btn" style="width:100%;padding:13px 18px;background:#00A8E0;color:#fff;font-size:14px;font-weight:600;border:none;border-radius:12px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;letter-spacing:.8px;font-family:DM Sans,sans-serif;box-shadow:0 6px 16px rgba(0,168,224,.18);transition:transform .16s ease,filter .16s ease">';
...
function showProductInfo(sku){
  ...
  h += '<div style="font-size:10px;color:var(--label3);font-family:DM Sans,sans-serif;margin-top:4px">SKU: '+acc.sku+'</div>';
  h += '</div>';
...
function buildSpecsPDFHTML(dev){
  ...
  return '<div class="specs-page" style="width:794px;height:1123px;overflow:hidden;background:#FFFFFF;font-family:\'DM Sans\',sans-serif;color:#26313D;line-height:1.35;box-sizing:border-box">'+
...
function openAsesorEdit(){
  ...
  attuidBox.innerHTML = '<div style="font-size:10px;color:var(--label3);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:3px">ATTUID</div><div style="font-size:14px;font-weight:600;font-family:DM Sans,sans-serif">'+asesorData.attuid+'</div>';
...
function _flyerFooter(discExtra, conRedes){
  ...
  if(typeof asesorData !== 'undefined' && asesorData && asesorData.name){
    ...
    h+='</div>';
    h+='<img class="flyer-v3-cotizador-logo" src="cotizador-pro-gris-v18.png" alt="Cotizador Pro" crossorigin="anonymous">';
    h+='</div>';
  }
...
console.log('✅ Cotizador Pro v45 — DM Sans global en interfaz y cotizaciones');
...
console.log('✅ Cotizador Pro v48 — DM Sans absoluta en toda la aplicación y generadores');

console.log('✅ Cotizador Pro v52 — tipografía DM Sans limpia, sin filtros artificiales');

console.log('✅ Cotizador Pro v54 — DM Sans con pesos reales 400/500/600/700/800; síntesis desactivada');
