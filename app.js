...
console.log('✅ Cotizador Pro v49 — DM Sans con render tipográfico de alta nitidez');

console.log('✅ Cotizador Pro v50 — render nativo ClearType/DM Sans sin suavizado forzado');
