...
function openDeviceCompareConfigurator(base,phase,done){_cmpCfgState=JSON.parse(JSON.stringify(base));_cmpCfgState.engPct=Number(_cmpCfgState.engPct||0);_cmpCfgState.engCustom=null;_cmpCfgState.rentas=Number(_cmpCfgState.rentas||0);_cmpCfgState.deposito=Number(_cmpCfgState.deposito||0);_cmpCfgPhase=phase||1;_cmpCfgDone=done||null;_cmpCfgEnsure().classList.add('show');_cmpCfgRender();}
